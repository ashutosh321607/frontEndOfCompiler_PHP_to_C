...
reserved = (
    ...
    #'ABSTRACT','AS','TRY', 'CATCH', 'THROW', 'NAMESPACE','FINALLY', 'TRAIT','CLASS','PUBLIC', 'PRIVATE','PROTECTED','INTERFACE', 'IMPLEMENTS','FINAL','DECLARE','ENDDECLARE','EXTENDS','VAR','NEW',
...
tokens = reserved+unparsed+(
    ...
    'ARRAY_CAST', 'NS_SEPARATOR', 'BINARY_CAST', 'BOOL_CAST', 'DOUBLE_CAST', 'INT_CAST', 
 ...
 #'STRING','SINGLE_QUOTE','OBJECT_CAST',
 # 'SPACESHIP','UNQUOTED_STRING',(implment if time is available)
